...
namespace Atko.Mirra.Generation
{
    class CodeGenerator
    {
        ...
        public static InstanceIndexerGetInvoker InstanceIndexGetter(PropertyInfo property, int argumentCount)
        {
            var instanceParameter = Expression.Parameter(typeof(object), "instance");
        ...
        public static InstanceIndexerSetInvoker InstanceIndexSetter(PropertyInfo property, int argumentCount)
        {
            var instanceParameter = Expression.Parameter(typeof(object), "instance");
            var castedInstanceParameter = Expression.Convert(instanceParameter, property.DeclaringType);
            var indexParameter = Expression.Parameter(typeof(object[]), "index");
