...
namespace Atko.Mirra
{
    ...
    public class TypeImage : MemberImage
    {
        ...
        static ConcurrentDictionary<Type, TypeImage> Cache { get; } = new ConcurrentDictionary<Type, TypeImage>();
        ...
        ConcurrentDictionary<Type, TypeImage> AssignableTypeCache { get; } = new ConcurrentDictionary<Type, TypeImage>();
